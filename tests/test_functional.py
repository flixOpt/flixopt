    ...
    flow_system.add_elements(
        fx.linear_converters.Boiler(
            ...
            Q_th=fx.Flow(
                'Q_th',
                bus='Fernwärme',
                size=fx.InvestParameters(fixed_size=1000, effects_of_size=10, effects_of_investment_per_size=1),
            ),
        )
    )
    ...
    flow_system.add_elements(
        fx.linear_converters.Boiler(
            ...
            Q_th=fx.Flow(
                'Q_th',
                bus='Fernwärme',
                size=fx.InvestParameters(effects_of_size=10, effects_of_investment_per_size=1),
            ),
        )
    )
    ...
    flow_system.add_elements(
        fx.linear_converters.Boiler(
            ...
            Q_th=fx.Flow(
                'Q_th',
                bus='Fernwärme',
                size=fx.InvestParameters(minimum_size=40, effects_of_size=10, effects_of_investment_per_size=1),
            ),
        )
    )
        ...
        fx.linear_converters.Boiler(
            ...
            Q_th=fx.Flow(
                ...
                size=fx.InvestParameters(
                    mandatory=False, minimum_size=40, effects_of_size=10, effects_of_investment_per_size=1
                ),
            ),
        ),
        fx.linear_converters.Boiler(
            ...
            Q_th=fx.Flow(
                ...
                bus='Fernwärme',
                size=fx.InvestParameters(
                    mandatory=False, minimum_size=50, effects_of_size=10, effects_of_investment_per_size=1
                ),
            ),
        ),
    )
