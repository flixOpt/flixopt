...
class TestClusteringModuleImports:
    ...
    def test_import_from_flixopt(self):
        ...
        assert hasattr(clustering, 'tsam_adapter')

    def test_clustering_class_has_required_methods(self):
        """Test that Clustering class has required methods."""
        ...
        assert hasattr(Clustering, 'to_reference')  # IO serialization
        assert hasattr(Clustering, 'from_reference')  # IO deserialization
