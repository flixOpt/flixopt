...
class TestTransmissionModel:
    def test_transmission_basic(self, basic_flow_system, highs_solver):
        ...
        transmission = fx.Transmission(
            ...
            relative_losses=0.2,
            absolute_losses=20,
            in1=fx.Flow('Rohr1', 'Wärme lokal', size=fx.SizingParameters(effects_per_size=5, maximum_size=1e6)),
    ...
    def test_transmission_balanced(self, basic_flow_system, highs_solver):
        ...
        transmission = fx.Transmission(
            ...
            in1=fx.Flow(
                'Rohr1a',
                bus='Wärme lokal',
                size=fx.SizingParameters(effects_per_size=5, maximum_size=1000),
            ),
            out1=fx.Flow('Rohr1b', 'Fernwärme', size=1000),
            in2=fx.Flow('Rohr2a', 'Fernwärme', size=fx.SizingParameters()),
    ...
    def test_transmission_unbalanced(self, basic_flow_system, highs_solver):
        ...
        transmission = fx.Transmission(
            ...
            in1=fx.Flow(
                'Rohr1a',
                bus='Wärme lokal',
                size=fx.SizingParameters(effects_per_size=50, maximum_size=1000),
            ),
            out1=fx.Flow('Rohr1b', 'Fernwärme', size=1000),
            in2=fx.Flow(
                'Rohr2a',
                'Fernwärme',
                size=fx.SizingParameters(effects_per_size=100, minimum_size=10, mandatory=True),
            ),
            out2=fx.Flow('Rohr2b', bus='Wärme lokal', size=1000),
            balanced=False,
        )
