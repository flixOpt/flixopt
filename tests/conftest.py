            ...
            return fx.linear_converters.Boiler(
                ...
                Q_th=fx.Flow(
                    ...
                    active_inactive_parameters=fx.ActivityParameters(
                        ...
                        consecutive_active_hours_min=1,
                        consecutive_inactive_hours_max=10,
                        effects_per_startup=0.01,
                        startup_total_max=1000,
                    ),
    ...
    flow_system.add_elements(
        fx.linear_converters.Boiler(
            ...
            Q_fu=fx.Flow(
                ...
                active_inactive_parameters=fx.ActivityParameters(effects_per_startup=1000),
            ),
        ),
        fx.linear_converters.CHP(
            ...
            eta_th=0.58,
            eta_el=0.22,
            active_inactive_parameters=fx.ActivityParameters(effects_per_startup=24000),
