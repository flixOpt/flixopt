...
def test_cluster_creates_reduced_timesteps(timesteps_8_days):
    ...
    assert hasattr(fs_reduced, 'cluster_info')
    assert fs_reduced.cluster_info.result.cluster_structure.n_clusters == 2
...
def test_expand_solution_withoutcluster_info_raises(solver_fixture, timesteps_2_days):
