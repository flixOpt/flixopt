...
class SourceAndSink(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        inputs, outputs, prevent_simultaneous_flow_rates = self._handle_deprecated_source_and_sink_params(
            kwargs, inputs, outputs, prevent_simultaneous_flow_rates
        )
    ...
    def _handle_deprecated_source_and_sink_params(self, kwargs, inputs, outputs, prevent_simultaneous_flow_rates):
        """Handle deprecated parameter names for SourceAndSink class."""
        import warnings

        # Handle deprecated 'source' parameter
        ...
        # Handle deprecated 'sink' parameter
        ...
        # Handle deprecated 'prevent_simultaneous_sink_and_source' parameter
        ...
        return inputs, outputs, prevent_simultaneous_flow_rates
...
class Source(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Handle deprecated parameters
        outputs = self._handle_deprecated_source_params(kwargs, outputs)
    ...
    def _handle_deprecated_source_params(self, kwargs, outputs):
        """Handle deprecated parameter names for Source class."""
        import warnings
...
class Sink(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        # Handle deprecated parameters
        inputs = self._handle_deprecated_sink_params(kwargs, inputs)
    ...
    def _handle_deprecated_sink_params(self, kwargs, inputs):
        """Handle deprecated parameter names for Sink class."""
        import warnings
