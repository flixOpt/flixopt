...
class Storage(Component):
    ...
    def __init__(
        ...
        relative_minimum_charge_state: Data[Time, Period, Scenario] = 0,
        relative_maximum_charge_state: Data[Time, Period, Scenario] = 1,
        ...
        eta_charge: Data[Time, Period, Scenario] = 1,
        eta_discharge: Data[Time, Period, Scenario] = 1,
        relative_loss_per_hour: Data[Time, Period, Scenario] = 0,
...
class Transmission(Component):
    ...
    def __init__(
        ...
        in2: Flow | None = None,
        out2: Flow | None = None,
        relative_losses: Data[Time, Period, Scenario] | None = None,
        absolute_losses: Data[Time, Period, Scenario] | None = None,
