...
class _DataMeta(type):
    """Metaclass for Data to enable subscript notation Data[Time, Scenario]."""

    def __getitem__(cls, dimensions):
        """
        Create a type hint showing maximum dimensions.
        ...
        # Return type that includes all possible input formats
