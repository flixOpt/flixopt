...
class InvestmentTimingModel(Submodel):
    ...
    def _basic_modeling(self):
        ...
        BoundingPatterns.link_changes_to_level_with_binaries(
            ...
            name=f'{self.label_of_element}|size_changes',
            max_change=size_max,
            initial_level=0,
            coord='year',
        )
