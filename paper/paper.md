...
FlixOpt is widely used in research projects. In the projects BBfly [References] and DigiHast [References], it has been applied to district heating operation, including load shifting, as well as to the optimization of storage design and operation. In KI-SKEN [References], FlixOpt serves as the basis for the development of an investment decision-support framework for energy consulting. Beyond its use in academic research, FlixOpt has also evolved into a strategic decision-support tool for investment planning in district heating systems at a German energy utility [Reference]. Furthermore, the framework is applied in several practice-oriented theses, thereby fostering the transfer of scientific methods into real-world applications and strengthening the link between academia and industry [References].
